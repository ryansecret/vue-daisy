export default {
  ...
  "el-alert/closable": {
    type: "boolean",
    description:
      "If closable or not, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/alert)"
  },
  "el-alert/center": {
    type: "boolean",
    description:
  ...
  "el-alert/show-icon": {
    type: "boolean",
    description:
      "If a type icon is displayed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/alert)"
  },
  "el-alert/effect": {
    type: "string",
    options: ["light", "dark"],
  ...
  "el-backtop/visibility-height": {
    type: "number",
    description:
      "the button will not show until the scroll height reaches this value, default: 200.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/backtop)"
  },
  "el-backtop/right": {
    type: "number",
    description:
      "right distance, default: 40.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/backtop)"
  },
  "el-backtop/bottom": {
    type: "number",
    description:
      "bottom distance, default: 40.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/backtop)"
  },
  "el-backtop/click": {
    type: "event",
    description:
  ...
  "el-badge/is-dot": {
    type: "boolean",
    description:
      "if a little dot is displayed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/badge)"
  },
  "el-badge/hidden": {
    type: "boolean",
    description:
      "hidden badge, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/badge)"
  },
  "el-badge/type": {
    type: "string",
  ...
  "el-button/plain": {
    type: "boolean",
    description:
      "determine whether it's a plain button, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/button)"
  },
  "el-button/round": {
    type: "boolean",
    description:
      "determine whether it's a round button, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/button)"
  },
  "el-button/circle": {
    type: "boolean",
    description:
      "determine whether it's a circle button, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/button)"
  },
  "el-button/loading": {
    type: "boolean",
    description:
      "determine whether it's loading, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/button)"
  },
  "el-button/disabled": {
    type: "boolean",
    description:
  ...
  "el-button/autofocus": {
    type: "boolean",
    description:
      "same as native button's `autofocus`, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/button)"
  },
  ...
  "el-card/body-style": {
    type: "object",
    description:
      "CSS style of body, default: { padding: '20px' }.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/card)"
  },
  "el-card/shadow": {
    type: "string",
    options: ["always", "hover", "never"],
    description:
      "when to show card shadows, default: always.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/card)"
  },
  "el-carousel/height": {
    type: "string",
    description:
  ...
  "el-carousel/initial-index": {
    type: "number",
    description:
      "index of the initially active slide (starting from 0), default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/trigger": {
    type: "string",
    options: ["hover", "click"],
    description:
      "how indicators are triggered, default: hover.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/autoplay": {
    type: "boolean",
    description:
      "whether automatically loop the slides, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/interval": {
    type: "number",
    description:
      "interval of the auto loop, in milliseconds, default: 3000.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  ...
  "el-carousel/arrow": {
    ...
    options: ["always", "hover", "never"],
    description:
      "when arrows are shown, default: hover.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/type": {
    type: "string",
    options: ["card"],
  ...
  "el-carousel/loop": {
    type: "boolean",
    description:
      "display the items in loop, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/direction": {
    type: "string",
    options: ["horizontal", "vertical"],
    description:
      "display direction, default: horizontal.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/carousel)"
  },
  "el-carousel/change": {
    type: "event",
    description:
  ...
  "el-cascader/placeholder": {
    type: "string",
    description:
      "placeholder of input, default: Select.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  "el-cascader/disabled": {
    type: "boolean",
    description:
      "whether Cascader is disabled, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  "el-cascader/clearable": {
    type: "boolean",
    description:
      "whether selected value can be cleared, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  "el-cascader/show-all-levels": {
    type: "boolean",
    description:
      "whether to display all levels of the selected value in the input, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  "el-cascader/collapse-tags": {
    type: "boolean",
    description:
      "whether to collapse tags in multiple selection mode, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  "el-cascader/separator": {
    type: "string",
    description:
      "option label separator, default: ' / '.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  ...
  "el-cascader/debounce": {
    type: "number",
    description:
      "debounce delay when typing filter keyword, in milliseconds, default: 300.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/cascader)"
  },
  ...
  "el-checkbox/border": {
    type: "boolean",
    description:
      "whether to add a border around Checkbox, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/checkbox)"
  },
  "el-checkbox/size": {
    type: "string",
    description:
  ...
  "el-checkbox/indeterminate": {
    type: "boolean",
    description:
      "same as `indeterminate` in native checkbox, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/checkbox)"
  },
  "el-checkbox/change": {
    type: "event",
    description:
  ...
  "el-collapse/accordion": {
    type: "boolean",
    description:
      "whether to activate accordion mode, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/collapse)"
  },
  "el-collapse/change": {
    type: "event",
    description:
  ...
  "el-descriptions/colon": {
    type: "boolean",
    description:
      "change default props colon value of Descriptions Item, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/descriptions)"
  },
  ...
  "el-dialog/fullscreen": {
    type: "boolean",
    description:
      "whether the Dialog takes up full screen, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/top": {
    type: "string",
    description:
      "value for `margin-top` of Dialog CSS, default: 15vh.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/modal": {
    type: "boolean",
    description:
      "whether a mask is displayed, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/modal-append-to-body": {
    type: "boolean",
    description:
      "whether to append modal to body element. If false, the modal will be appended to Dialog's parent element, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/append-to-body": {
    type: "boolean",
    description:
      "whether to append Dialog itself to body. A nested Dialog should have this attribute set to `true`, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/lock-scroll": {
    type: "boolean",
    description:
      "whether scroll of body is disabled while Dialog is displayed, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  ...
  "el-dialog/center": {
    type: "boolean",
    description:
      "whether to align the header and footer in center, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/destroy-on-close": {
    type: "boolean",
    description:
      "Destroy elements in Dialog when closed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dialog)"
  },
  "el-dialog/open": {
    type: "event",
    description:
  ...
  "el-dropdown/split-button": {
    type: "boolean",
    description:
      "whether a button group is displayed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  "el-dropdown/placement": {
    type: "string",
    options: ["top", "top-start", "top-end", "bottom", "bottom-start", "bottom-end"],
    description:
      "placement of pop menu, default: bottom-end.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  "el-dropdown/trigger": {
    type: "string",
    options: ["hover", "click"],
  ...
  "el-dropdown/hide-on-click": {
    type: "boolean",
    description:
      "whether to hide menu after clicking menu-item, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  "el-dropdown/show-timeout": {
    type: "number",
    description:
      "Delay time before show a dropdown (only works when trigger is `hover`), default: 250.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  "el-dropdown/hide-timeout": {
    type: "number",
    description:
      "Delay time before hide a dropdown (only works when trigger is `hover`), default: 150.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  "el-dropdown/tabindex": {
    type: "number",
    description:
      "[tabindex](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex) of Dropdown, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/dropdown)"
  },
  ...
  "el-form/inline": {
    type: "boolean",
    description:
      "whether the form is inline, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  "el-form/label-position": {
    type: "string",
    options: ["left", "right", "top"],
    description:
      "position of label. If set to 'left' or 'right', `label-width` prop is also required, default: right.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  "el-form/label-width": {
    type: "string",
    description:
  ...
  "el-form/hide-required-asterisk": {
    type: "boolean",
    description:
      "whether to hide a red asterisk (star) next to the required field label., default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  ...
  "el-form/status-icon": {
    type: "boolean",
    description:
      "whether to display an icon indicating the validation result, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  "el-form/validate-on-rule-change": {
    type: "boolean",
    description:
      "whether to trigger validation when the `rules` prop is changed, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  "el-form/size": {
    type: "string",
    options: ["medium", "small", "mini"],
  ...
  "el-form/disabled": {
    type: "boolean",
    description:
      "whether to disabled all components in this form. If set to true, it cannot be overridden by its inner components' `disabled` prop, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/form)"
  },
  "el-form/validate": {
    type: "event",
    description:
  ...
  "el-image/lazy": {
    type: "boolean",
    description:
      "Whether to use lazy load, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/image)"
  },
  "el-image/scroll-container": {
    type: "string|htmlelement",
    description:
      "The container to add scroll listener when using lazy load, default: The nearest parent container whose overflow property is auto or scroll.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/image)"
  },
  ...
  "el-image/z-index": {
    type: "number",
    description:
      "set image preview z-index, default: 2000.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/image)"
  },
  "el-image/load": {
    type: "event",
    description:
  ...
  "el-input/show-word-limit": {
    type: "boolean",
    description:
      "whether show word count，only works when `type` is 'text' or 'textarea', default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  ...
  "el-input/show-password": {
    type: "boolean",
    description:
      "whether to show toggleable password input, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/disabled": {
    type: "boolean",
    description:
  ...
  "el-input/rows": {
    type: "number",
    description:
      "number of rows of textarea, only works when `type` is 'textarea', default: 2.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/autosize": {
    type: "boolean|object",
    description:
      "whether textarea has an adaptive height, only works when `type` is 'textarea'. Can accept an object, e.g. { minRows: 2, maxRows: 6 }, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/autocomplete": {
    type: "string",
    options: ["on", "off"],
    description:
      "same as `autocomplete` in native input, default: off.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/auto-complete": {
    type: "string",
    options: ["on", "off"],
    description:
      "@DEPRECATED in next major version, default: off.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/name": {
    type: "string",
    description:
  ...
  "el-input/readonly": {
    type: "boolean",
    description:
      "same as `readonly` in native input, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/max": {
    description:
  ...
  "el-input/autofocus": {
    type: "boolean",
    description:
      "same as `autofocus` in native input, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/input)"
  },
  "el-input/form": {
    type: "string",
    description:
  ...
  "el-link/underline": {
    type: "boolean",
    description:
      "whether the component has underline, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/link)"
  },
  "el-link/disabled": {
    type: "boolean",
    description:
  ...
  "el-pagination/small": {
    type: "boolean",
    description:
      "whether to use small pagination, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  "el-pagination/background": {
    type: "boolean",
    description:
      "whether the buttons have a background color, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  "el-pagination/page-size": {
    type: "number",
    description:
      "item count of each page, supports the .sync modifier, default: 10.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  "el-pagination/total": {
    type: "number",
    description:
  ...
  "el-pagination/pager-count": {
    type: "number",
    options: ["odd number between 5 and 21"],
    description:
      "number of pagers. Pagination collapses when the total page count exceeds this value, default: 7.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  "el-pagination/current-page": {
    type: "number",
    description:
      "current page number, supports the .sync modifier, default: 1.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  "el-pagination/layout": {
    type: "string",
    options: ["sizes, prev, pager, next, jumper, ->, total, slot"],
    description:
      "layout of Pagination, elements separated with a comma, default: 'prev, pager, next, jumper, ->, total'.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/pagination)"
  },
  ...
  "el-popover/width": {
    type: "string|number",
    description:
      "popover width, default: Min width 150px.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  ...
  "el-popover/disabled": {
    type: "boolean",
    description:
      "whether Popover is disabled, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/model-value": {
    type: "boolean",
    description:
      "whether popover is visible, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/offset": {
    type: "number",
    description:
      "popover offset, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/transition": {
    type: "string",
    description:
      "popover transition animation, default: el-fade-in-linear.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/visible-arrow": {
    type: "boolean",
    description:
      "whether a tooltip arrow is displayed or not. For more info, please refer to [Vue-popper](https://github.com/element-component/vue-popper), default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/popper-options": {
    type: "object",
    description:
      "parameters for [popper.js](https://popper.js.org/documentation.html), default: { boundariesElement: 'body', gpuAcceleration: false }.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  ...
  "el-popover/close-delay": {
    type: "number",
    description:
      "delay before disappearing when `trigger` is hover, in milliseconds, default: 200.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/tabindex": {
    type: "number",
    description:
      "[tabindex](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex) of Popover, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/popover)"
  },
  "el-popover/show": {
    type: "event",
    description:
  ...
  "el-progress/type": {
    ...
    description:
      "the type of progress bar, default: line.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/progress)"
  },
  "el-progress/status": {
    type: "string",
  ...
  "el-progress/color": {
    ...
    description:
      "background color of progress bar. Overrides `status` prop, default: ''.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/progress)"
  },
  "el-progress/width": {
    type: "number",
    description:
      "the canvas width of circle progress bar, default: 126.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/progress)"
  },
  ...
  "el-progress/stroke-linecap": {
    ...
    description:
      "circle/dashboard type shape at the end path, default: round.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/progress)"
  },
  "el-progress/format": {
    type: "function",
    description:
  ...
  "el-radio/border": {
    type: "boolean",
    description:
      "whether to add a border around Radio, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/radio)"
  },
  "el-radio/size": {
    type: "string",
    options: ["medium", "small", "mini"],
  ...
  "el-rate/max": {
    type: "number",
    description:
      "max rating score, default: 5.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/disabled": {
    type: "boolean",
    description:
      "whether Rate is read-only, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/allow-half": {
    type: "boolean",
    description:
      "whether picking half start is allowed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/low-threshold": {
    type: "number",
    description:
      "threshold value between low and medium level. The value itself will be included in low level, default: 2.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/high-threshold": {
    type: "number",
    description:
      "threshold value between medium and high level. The value itself will be included in high level, default: 4.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/colors": {
    type: "array|object",
    description:
      "colors for icons. If array, it should have 3 elements, each of which corresponds with a score level, else if object, the key should be threshold value between two levels, and the value should be corresponding color, default: ['#F7BA2A', '#F7BA2A', '#F7BA2A'].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/void-color": {
    type: "string",
    description:
      "color of unselected icons, default: #C6D1DE.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/disabled-void-color": {
    type: "string",
    description:
      "color of unselected read-only icons, default: #EFF2F7.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/icon-classes": {
    type: "array|object",
    description:
      "class names of icons. If array, ot should have 3 elements, each of which corresponds with a score level, else if object, the key should be threshold value between two levels, and the value should be corresponding icon class, default: ['el-icon-star-on', 'el-icon-star-on','el-icon-star-on'].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/void-icon-class": {
    type: "string",
    description:
      "class name of unselected icons, default: el-icon-star-off.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/disabled-void-icon-class": {
    type: "string",
    description:
      "class name of unselected read-only icons, default: el-icon-star-on.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/show-text": {
    type: "boolean",
    description:
      "whether to display texts, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/show-score": {
    type: "boolean",
    description:
      "whether to display current score. show-score and show-text cannot be true at the same time, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/text-color": {
    type: "string",
    description:
      "color of texts, default: #1F2D3D.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/texts": {
    type: "array",
    description:
      "text array, default: ['极差', '失望', '一般', '满意', '惊喜'].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/score-template": {
    type: "string",
    description:
      "score template, default: {value}.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/rate)"
  },
  "el-rate/change": {
    type: "event",
    description:
  ...
  "el-select/multiple": {
    type: "boolean",
    description:
      "whether multiple-select is activated, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/disabled": {
    type: "boolean",
    description:
  ...
  "el-select/value-key": {
    type: "string",
    description:
      "unique identity key name for value, required when value is an object, default: value.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/size": {
    type: "string",
  ...
  "el-select/clearable": {
    type: "boolean",
    description:
      "whether select can be cleared, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/collapse-tags": {
    type: "boolean",
    description:
      "whether to collapse tags to a text when multiple selecting, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/multiple-limit": {
    type: "number",
    description:
      "maximum number of options user can select when `multiple` is `true`. No limit when set to 0, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/name": {
    type: "string",
    description:
  ...
  "el-select/autocomplete": {
    type: "string",
    description:
      "the autocomplete attribute of select input, default: off.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  ...
  "el-select/filterable": {
    type: "boolean",
    description:
      "whether Select is filterable, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/allow-create": {
    type: "boolean",
    description:
      "whether creating new items is allowed. To use this, `filterable` must be true, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  ...
  "el-select/remote": {
    type: "boolean",
    description:
      "whether options are loaded from server, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  ...
  "el-select/loading": {
    type: "boolean",
    description:
      "whether Select is loading data from server, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/loading-text": {
    type: "string",
    description:
      "displayed text while loading data from server, default: Loading.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/no-match-text": {
    type: "string",
    description:
      "displayed text when no data matches the filtering query, you can also use slot `empty`, default: No matching data.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/no-data-text": {
    type: "string",
    description:
      "displayed text when there is no options, you can also use slot `empty`, default: No data.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  ...
  "el-select/reserve-keyword": {
    type: "boolean",
    description:
      "when `multiple` and `filter` is true, whether to reserve current keyword after selecting an option, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/default-first-option": {
    type: "boolean",
    description:
      "select first matching option on enter key. Use with `filterable` or `remote`, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/popper-append-to-body": {
    type: "boolean",
    description:
      "whether to append the popper menu to body. If the positioning of the popper is wrong, you can try to set this prop to false, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/automatic-dropdown": {
    type: "boolean",
    description:
      "for non-filterable Select, this prop decides if the option menu pops up when the input is focused, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/select)"
  },
  "el-select/change": {
    type: "event",
    description:
  ...
  "el-slider/show-input": {
    type: "boolean",
    description:
      "whether to display an input box, works when `range` is false, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/show-input-controls": {
    type: "boolean",
    description:
      "whether to display control buttons when `show-input` is true, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/input-size": {
    type: "string",
    options: ["large", "medium", "small", "mini"],
    description:
      "size of the input box, default: small.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/show-stops": {
    type: "boolean",
    description:
      "whether to display breakpoints, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/show-tooltip": {
    type: "boolean",
    description:
      "whether to display tooltip value, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  ...
  "el-slider/range": {
    type: "boolean",
    description:
      "whether to select a range, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/vertical": {
    type: "boolean",
    description:
      "vertical mode, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  "el-slider/height": {
    type: "string",
    description:
  ...
  "el-slider/debounce": {
    type: "number",
    description:
      "debounce delay when typing, in milliseconds, works when `show-input` is true, default: 300.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/slider)"
  },
  ...
  "el-space/size": {
    ...
    description:
      "Spacing size, default: default.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-space/alignment": {
    type: "string",
    description:
      "Controls the alignment of items, default: center.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-space/direction": {
    type: "string",
    options: ["vertical", "horizontal"],
    description:
      "Placement direction, default: horizontal.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-space/wrap": {
    type: "boolean",
    options: ["true", "false"],
    description:
      "Auto wrapping, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-space/spacer": {
  ...
  "el-space/fill": {
    ...
    options: ["true", "false"],
    description:
      "Whether to fill the container, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-space/fill-ratio": {
    type: "number",
    description:
      "Ratio of fill, default: 100.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/space)"
  },
  "el-steps/space": {
    type: "number|string",
    description:
  ...
  "el-steps/active": {
    type: "number",
    description:
      "current activation step, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/steps)"
  },
  "el-steps/process-status": {
    type: "string",
    options: ["wait", "process", "finish", "error", "success"],
    description:
      "status of current step, default: process.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/steps)"
  },
  "el-steps/finish-status": {
    type: "string",
    options: ["wait", "process", "finish", "error", "success"],
    description:
      "status of end step, default: finish.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/steps)"
  },
  "el-steps/align-center": {
    type: "boolean",
    description:
      "center title and description, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/steps)"
  },
  "el-steps/simple": {
    type: "boolean",
    description:
  ...
  "el-switch/disabled": {
    type: "boolean",
    description:
      "whether Switch is disabled, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/switch)"
  },
  "el-switch/width": {
    type: "number",
    description:
      "width of Switch, default: 40.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/switch)"
  },
  ...
  "el-switch/active-value": {
    type: "boolean|string|number",
    description:
      "switch value when in `on` state, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/switch)"
  },
  "el-switch/inactive-value": {
    type: "boolean|string|number",
    description:
      "switch value when in `off` state, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/switch)"
  },
  "el-switch/name": {
    type: "string",
    description:
  ...
  "el-table/fit": {
    type: "boolean",
    description:
      "whether width of column automatically fits its container, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/show-header": {
    type: "boolean",
    description:
      "whether Table header is visible, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/highlight-current-row": {
    type: "boolean",
    description:
      "whether current row is highlighted, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  ...
  "el-table/empty-text": {
    type: "string",
    description:
      'Displayed text when data is empty. You can customize this area with `slot="empty"`, default: No Data.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)'
  },
  "el-table/default-expand-all": {
    type: "boolean",
    description:
      'whether expand all rows by default, works when the table has a column type="expand" or contains tree structure data, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)'
  },
  ...
  "el-table/default-sort": {
    ...
    description:
      "set the default sort column and order. property `prop` is used to set default sort column, property `order` is used to set default sort order, default: if `prop` is set, and `order` is not set, then `order` is default to ascending.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  ...
  "el-table/show-summary": {
    type: "boolean",
    description:
      "whether to display a summary row, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/sum-text": {
    type: "string",
    description:
      "displayed text for the first column of summary row, default: Sum.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  ...
  "el-table/select-on-indeterminate": {
    type: "boolean",
    description:
      "controls the behavior of master checkbox in multi-select tables when only some rows are selected (but not all). If true, all rows will be selected, else deselected., default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/indent": {
    type: "number",
    description:
      "horizontal indentation of tree data, default: 8.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/lazy": {
    type: "boolean",
    description:
  ...
  "el-table/tree-props": {
    type: "object",
    description:
      "configuration for rendering nested data, default: { hasChildren: 'hasChildren', children: 'children' }.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/table)"
  },
  "el-table/select": {
    type: "event",
    description:
  ...
  "el-tabs/addable": {
    type: "boolean",
    description:
      "whether Tab is addable, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tabs)"
  },
  "el-tabs/editable": {
    type: "boolean",
    description:
      "whether Tab is addable and closable, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tabs)"
  },
  "el-tabs/tab-position": {
    type: "string",
    options: ["top", "right", "bottom", "left"],
    description:
      "position of tabs, default: top.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tabs)"
  },
  "el-tabs/stretch": {
    type: "boolean",
    description:
      "whether width of tab automatically fits its container, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tabs)"
  },
  ...
  "el-tag/closable": {
    type: "boolean",
    description:
      "whether Tag can be removed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tag)"
  },
  ...
  "el-tag/hit": {
    type: "boolean",
    description:
      "whether Tag has a highlighted border, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tag)"
  },
  "el-tag/color": {
    type: "string",
    description:
  ...
  "el-text/type": {
    ...
    options: ["primary", "success", "warning", "danger", "info"],
    description:
      "text type\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/text)"
  },
  "el-text/size": {
    type: "string",
  ...
  "el-tooltip/placement": {
    ...
    description:
      "position of Tooltip, default: bottom.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/model-value": {
    type: "boolean",
    description:
      "visibility of Tooltip, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/disabled": {
    type: "boolean",
    description:
  ...
  "el-tooltip/offset": {
    type: "number",
    description:
      "offset of the Tooltip, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/transition": {
    type: "string",
    description:
      "animation name, default: el-fade-in-linear.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/visible-arrow": {
    type: "boolean",
    description:
      "whether an arrow is displayed. For more information, check [Vue-popper](https://github.com/element-component/vue-popper) page, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/popper-options": {
    type: "object",
    description:
      "[popper.js](https://popper.js.org/documentation.html) parameters, default: { boundariesElement: 'body', gpuAcceleration: false }.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/open-delay": {
    type: "number",
    description:
      "delay of appearance, in millisecond, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/manual": {
    type: "boolean",
    description:
      "whether to control Tooltip manually. `mouseenter` and `mouseleave` won't have effects if set to `true`, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  ...
  "el-tooltip/enterable": {
    type: "boolean",
    description:
      "whether the mouse can enter the tooltip, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/hide-after": {
    type: "number",
    description:
      "timeout in milliseconds to hide tooltip, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  "el-tooltip/tabindex": {
    type: "number",
    description:
      "[tabindex](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex) of Tooltip, default: 0.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tooltip)"
  },
  ...
  "el-transfer/filterable": {
    type: "boolean",
    description:
      "whether Transfer is filterable, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/filter-placeholder": {
    type: "string",
    description:
      "placeholder for the filter input, default: Enter keyword.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  ...
  "el-transfer/target-order": {
    ...
    description:
      "order strategy for elements in the target list. If set to `original`, the elements will keep the same order as the data source. If set to `push`, the newly added elements will be pushed to the bottom. If set to `unshift`, the newly added elements will be inserted on the top, default: original.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/titles": {
    type: "array",
    description:
      "custom list titles, default: ['List 1', 'List 2'].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/button-texts": {
    type: "array",
    description:
      "custom button texts, default: [ ].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  ...
  "el-transfer/format": {
    ...
    description:
      "texts for checking status in list header, default: { noChecked: '${checked}/${total}', hasChecked: '${checked}/${total}' }.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/props": {
  ...
  "el-transfer/left-default-checked": {
    type: "array",
    description:
      "key array of initially checked data items of the left list, default: [ ].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/right-default-checked": {
    type: "array",
    description:
      "key array of initially checked data items of the right list, default: [ ].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/transfer)"
  },
  "el-transfer/change": {
    type: "event",
    description:
  ...
  "el-tree/render-after-expand": {
    type: "boolean",
    description:
      "whether to render child nodes only after a parent node is expanded for the first time, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/load": {
    type: "function",
    description:
  ...
  "el-tree/highlight-current": {
    type: "boolean",
    description:
      "whether current node is highlighted, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  ...
  "el-tree/expand-on-click-node": {
    type: "boolean",
    description:
      "whether to expand or collapse node when clicking on the node, if false, then expand or collapse node only when clicking on the arrow icon., default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/check-on-click-node": {
    type: "boolean",
    description:
      "whether to check or uncheck node when clicking on the node, if false, the node can only be checked or unchecked by clicking on the checkbox., default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/auto-expand-parent": {
    type: "boolean",
    description:
      "whether to expand father node when a child node is expanded, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  ...
  "el-tree/show-checkbox": {
    type: "boolean",
    description:
      "whether node is selectable, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/check-strictly": {
    type: "boolean",
    description:
      "whether checked state of a node not affects its father and child nodes when `show-checkbox` is `true`, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  ...
  "el-tree/accordion": {
    type: "boolean",
    description:
      "whether only one node among the same level can be expanded at one time, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/indent": {
    type: "number",
    description:
      "horizontal indentation of nodes in adjacent levels in pixels, default: 16.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/icon-class": {
    type: "string",
    description:
      "custome tree node icon\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/lazy": {
    type: "boolean",
    description:
      "whether to lazy load leaf node, used with `load` attribute, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/draggable": {
    type: "boolean",
    description:
      "whether enable tree nodes drag and drop, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/tree)"
  },
  "el-tree/allow-drag": {
    type: "function",
    description:
  ...
  "el-upload/name": {
    type: "string",
    description:
      "key name for uploaded file, default: file.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/with-credentials": {
    type: "boolean",
    description:
      "whether cookies are sent, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  ...
  "el-upload/drag": {
    type: "boolean",
    description:
      "whether to activate drag and drop mode, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/accept": {
    type: "string",
    description:
  ...
  "el-upload/thumbnail-mode": {
    type: "boolean",
    description:
      "whether thumbnail is displayed, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/file-list": {
    type: "array",
    description:
      "default uploaded files, e.g. [{name: 'food.jpg', url: 'https://xxx.cdn.com/xxx.jpg'}], default: [].\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/list-type": {
    type: "string",
    options: ["text", "picture", "picture-card"],
    description:
      "type of fileList, default: text.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/auto-upload": {
    type: "boolean",
    description:
      "whether to auto upload file, default: true.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  ...
  "el-upload/disabled": {
    type: "boolean",
    description:
      "whether to disable upload, default: false.\n\n[Docs](https://j.jdcloud.com/jelement-next/jelement-docs/dev/index.html#/zh-CN/component/upload)"
  },
  "el-upload/limit": {
    type: "number",
    description:
