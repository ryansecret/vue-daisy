export default {
  ...
  "el-input/type": { "description": "Same as the 'type' attribute of native input, except that it can be 'textarea'", "options": ["textarea", "text"] },
  ...
  "class": { "global": true, "framework": "element-ui", "options": ["jc-status", "jc-status--blue", "jc-status--green", "jc-status--twinkling", "jc-icon-edit", "el-icon-arrow-down", "jc-page-container", "jc-page-header", "jc-page-content", "jc-page-card__title", "jc-page-card__content"], "description": "" },
  ...
  "prefix-icon": { "version": ">=2.0.0", "type": "icon", "description": "prefix icon class" },
  "suffix-icon": { "version": ">=2.0.0", "type": "icon", "description": "suffix icon class" },
